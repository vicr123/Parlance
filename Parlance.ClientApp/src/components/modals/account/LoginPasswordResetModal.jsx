...
export default withTranslation()(
    class LoginPasswordResetModal extends React.Component {
        constructor(props) {
            super(props);
        ...
        render(props) {
            return (
                <Modal
                    heading={this.props.t("RESET_PASSWORD")}
                    buttons={[
                        {
                ...
                >
                    <div style={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <LineEdit
                            ...
                            onChange={this.passwordTextChanged.bind(this)}
                        />
                        <LineEdit
                            password={true}
                            type={"password"}
                            ...
                            onChange={this.confirmPasswordTextChanged.bind(
                                this,
                            )}
                        />
                    </div>
