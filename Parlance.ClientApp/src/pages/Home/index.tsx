    ...
    return (
        <div>
            <Promo>
                <div>
                    <div
                        className={Styles.promoHeader}>{t("HOME_HERO_TITLE", {serverName: serverInformation.serverName})}</div>
                    <div
                        className={Styles.promoSub}>{t("HOME_HERO_SUBTITLE", {serverName: serverInformation.serverName})}</div>
                </div>
