...
export default function UnknownPage() {
    ...
    return <div className={Styles.unknownPage}>
        <PageHeading level={1}>{t("NOT_FOUND_TITLE")}</PageHeading>
        <Bonkers />
        <p>{t("NOT_FOUND_DESCRIPTION")}</p>
        <SmallButton onClick={() => navigate("/")}>{t("NOT_FOUND_GO_HOME")}</SmallButton>
    </div>
}

function Bonkers() {
    return <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 16.933 16.933"
        ...
        <g transform="translate(0 -280.067)">
            ...
            <circle cx="4.233" cy="283.242" r="1.058"
                    style={{
                        opacity: 1,
                        fill: 'var(--svg-fg)',
                        fillOpacity: 1,
            ...
            <path d="M6.395 283.621a6.35 6.35 0 0 1 2.547 1.71M1.146 287.795a6.22 6.22 0 0 1 7.85-2.437"
                  style={{
                      opacity: 1,
                      fill: 'none',
                      fillOpacity: 1,
            ...
            <path d="m9.26 286.417-1.058.264"
                  style={{
                      fill: 'none',
                      stroke: 'var(--svg-fg)',
                      strokeWidth: 0.264583,
