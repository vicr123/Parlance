...
import {
    Channel,
    ChannelSubscriptionsActions,
    ChannelSubscriptionState,
} from "@/pages/Account/Notifications/Channel";
...
export function NotificationsSettings() {
    ...
    const [channels, dispatchChannels] = useReducer(
        (
            state: ChannelSubscriptionState[],
            action: ChannelSubscriptionsActions,
        ) => {
                ...
                case "set":
                    return state.map(item => {
                        if (
                            ...
                            item.subscriptionData == action.subscriptionData
                        ) {
    ...
    const updateChannelSubscriptionState = async () => {
        const response = await Fetch.get<ChannelSubscriptionState[]>(
