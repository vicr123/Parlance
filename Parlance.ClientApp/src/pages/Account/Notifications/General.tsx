...
export function GeneralNotificationSettings() {
    ...
    const updateEmailNotificationsState = async () => {
        const response = await Fetch.get<{ unsubscribed: boolean }>(
        ...
        <div>
            <ListPageBlock>
                <VerticalLayout>
                    ...
                    <span>
                        {t(
                            "If you don't want to receive any email notifications from Parlance, you can turn off email notifications altogether.",
                        )}
                    </span>
                    <span>
