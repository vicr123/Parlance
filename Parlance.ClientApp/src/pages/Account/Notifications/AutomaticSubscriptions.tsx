...
export function AutomaticSubscriptions() {
    ...
    const [subscriptions, dispatchSubscriptions] = useReducer(
        (state: AutoSubscriptionState[], action: SubscriptionsActions) => {
    ...
    const updateAutoSubscriptionsState = async () => {
        const response = await Fetch.get<AutoSubscriptionState[]>(
            "/api/notifications/autosubscriptions",
        );
    ...
    const setAutoSubscription = async (
        channel: SubscriptionChannelName,
        event: AutoSubscriptionEventName,
        subscribed: boolean,
    ) => {
    ...
    return (
        <>
            <ListPageBlock>
                <VerticalLayout>
                    <PageHeading level={3}>
                        {t("AUTO_SUBSCRIPTION_SETTINGS_TITLE")}
                    </PageHeading>
                                        ...
                                        contents: (
                                            ...
                                            >
                                                ...
                                                <AutoSubscriptionEvent
                                                    ...
                                                    type={
                                                        AutoSubscriptionEventType.PresentTenseAction
                                                    }
                                                />
                                            </Trans>
                                        ),
