...
function TranslationPart({entry, translationDirection, sourceTranslation, translationFileType, onTranslationUpdate}) {
    ...
    let translationPreview = <p className={Styles.translationPreview}>{translationContent.replace("%n", pluralExample?.number !== undefined ? i18n.number(language, pluralExample.number) : "%n")}</p>
